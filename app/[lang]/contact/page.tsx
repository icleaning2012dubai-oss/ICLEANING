            ...
            <div className="max-w-[1400px] mx-auto">
              <div className="text-center">
                <div className="flex items-center justify-center gap-3 text-sm text-gray-600 mb-8">
                  <a href={getLocalizedPath('/')} className="hover:text-blue-600 transition-colors">{t('breadcrumb.home')}</a>
                  <span>/</span>
                    ...
                    <div className="bg-gradient-to-br from-blue-50/50 to-blue-100/50 rounded-3xl p-6 hover:shadow-lg transition-all duration-300 border-2 border-blue-100">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <a href="tel:+971565055016" data-gtm-phone="true" onClick={() => { if (typeof window !== 'undefined' && (window as any).dataLayer) { (window as any).dataLayer.push({ event: 'phone_click', click_value: 30 }); } }} className="text-xl md:text-2xl text-blue-600 hover:text-blue-700 font-bold transition-colors block">
                            +971 56 505 5016
                          </a>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                      ...
                      <a href={buildWhatsAppLink(language, pathname)} target="_blank" rel="noopener noreferrer" className="group relative bg-white/10 backdrop-blur-md rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-white/20 hover:border-green-400 cursor-pointer">
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">WhatsApp <svg className="w-5 h-5 text-gray-400 group-hover:text-green-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg></h3>
                        </div>
                      ...
                      {/* Instagram */}
                      <a href="https://www.instagram.com/icleaning_dubai/" target="_blank" rel="noopener noreferrer" className="group relative bg-white/10 backdrop-blur-md rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-white/20 hover:border-pink-400 cursor-pointer">
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">Instagram <svg className="w-5 h-5 text-gray-400 group-hover:text-pink-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg></h3>
                        </div>
                        <p className="text-gray-700 text-sm leading-relaxed">
                      ...
                      {/* Telegram */}
                      <a href="https://t.me/icleaning_dubai" target="_blank" rel="noopener noreferrer" className="group relative bg-white/10 backdrop-blur-md rounded-3xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 border-2 border-white/20 hover:border-blue-400 cursor-pointer">
                        <div className="flex items-center gap-4 mb-4">
                          ...
                          <h3 className="text-xl font-bold text-gray-900 flex items-center gap-2">Telegram <svg className="w-5 h-5 text-gray-400 group-hover:text-blue-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg></h3>
                        </div>
                        <p className="text-gray-700 text-sm leading-relaxed">
