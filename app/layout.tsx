  ...
  return (
    <html lang={lang} dir={dir} suppressHydrationWarning>
      <head>
        ...
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-RXQS8GDG2B" />
        <script
          dangerouslySetInnerHTML={{
            __html: `window.dataLayer = window.dataLayer || [];
              function gtag(){dataLayer.push(arguments);}
              gtag('js', new Date());
              gtag('config', 'G-RXQS8GDG2B');`,
          }}
        />
        ...
        <script
          dangerouslySetInnerHTML={{
            ...
            })(window,document,'script','https://mc.yandex.ru/metrika/tag.js?id=104388590','ym');
            ym(104388590,'init',{ssr:true,webvisor:true,clickmap:true,ecommerce:'dataLayer',referrer:document.referrer,url:location.href,accurateTrackBounce:true,trackLinks:true});`,
          }}
        />
      ...
      >
        ...
        <noscript>
          <div>
            <img src="https://mc.yandex.ru/watch/104388590" style={{ position: 'absolute', left: '-9999px' }} alt="" />
          </div>
        </noscript>
        {children}
      </body>
