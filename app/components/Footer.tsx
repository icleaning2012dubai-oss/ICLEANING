      ...
      <div className="max-w-[1400px] mx-auto bg-gray-900 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden">
        <div className="px-5 sm:px-8 md:px-12 lg:px-16 py-8 sm:py-12 md:py-16 text-white">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="space-y-3 sm:space-y-4">
              <a href="https://api.whatsapp.com/send/?phone=971508648401&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" data-gtm-whatsapp="true" className="flex items-center gap-3 text-gray-300 hover:text-white transition-colors group">
